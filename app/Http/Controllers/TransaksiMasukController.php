...
class TransaksiMasukController extends Controller
{
    ...
    public function printTransIn()
    {
        $data = Transaksi_masuk::all();
        $pdf = PDF::loadView('laporan/masuk/transaksiMasuk-pdf', compact('data'));
        $pdf->setPaper('A4', 'potrait');
        return $pdf->stream('transaksiMasuk.pdf');
    }
}
